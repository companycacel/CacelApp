...
namespace NetSDKCS
{
    public static class NETClient
    {
        ...
        /// </summary>
        /// <returns>failed return false, successful return true 失败返回false 成功返回true</returns>
        public static IntPtr StartService(uint wPort, IntPtr pIp, fServiceCallBack pfscb, uint dwTimeOut = 0xffffffff, IntPtr dwUserData = new IntPtr())
        {
            IntPtr result = OriginalSDK.CLIENT_StartService(wPort, pIp, pfscb, dwTimeOut, dwUserData);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <returns>返回处理句柄</returns>
        public static IntPtr AttachViewRangeState(IntPtr lLoginID, ref NET_IN_VIEW_RANGE_STATE pstuInViewRange, ref NET_OUT_VIEW_RANGE_STATE pstuOutViewRange, int nWaitTime)
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_AttachViewRangeState(lLoginID, ref pstuInViewRange, ref pstuOutViewRange, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <returns>TRUE表示成功 FALSE表示失败</returns>
        public static bool DetachViewRangeState(IntPtr lAttachHandle)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_DetachViewRangeState(lAttachHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID: 登录句柄; [in] lLoginID: Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam: 接口输入参数, 内存资源由用户申请和释放; [in] pstuInParam: Interface input parameters; memory managed by the user</param>
        /// <param name="pstuOutParam">[out] pstuOutParam: 接口输出参数, 内存资源由用户申请和释放; [out] pstuOutParam: Interface output parameters; memory managed by the user</param>
        /// <param name="nWaitTime">[in] nWaitTime: 接口超时时间, 单位毫秒; [in] nWaitTime: Interface timeout duration, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE if successful, FALSE if failed</returns>
        public static bool GetPeripheralChipPerformanceInfoByID(IntPtr lLoginID, ref NET_IN_GET_CHIP_PERFORMANCE_BYID_INFO pstuInParam, ref NET_OUT_GET_CHIP_PERFORMANCE_BYID_INFO pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetPeripheralChipPerformanceInfoByID(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID: 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam: 接口输入参数, 内存资源由用户申请和释放; [in] pstuInParam input param, memory resources are applied and released by the user</param>
        /// <param name="pstuOutParam">[out] pstuOutParam: 接口输出参数, 内存资源由用户申请和释放; [out] pstuOutParam output param, memory resources are applied and released by the user</param>
        /// <param name="nWaitTime">[in] nWaitTime: 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE:success FALSE:failed</returns>
        public static bool UpgraderGetChipList(IntPtr lLoginID, ref NET_IN_UPGRADER_GET_CHIPLIST_INFO pstuInParam, ref NET_OUT_UPGRADER_GET_CHIPLIST_INFO pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_UpgraderGetChipList(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <param name="nWaitTime">[in] nWaitTime: 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE:success FALSE:failed</returns>
        public static bool GetPeripheralChipStateByID(IntPtr lLoginID, ref NET_IN_GET_CHIP_STATE_BYID_INFO pstuInParam, ref NET_OUT_GET_CHIP_STATE_BYID_INFO pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetPeripheralChipStateByID(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <returns>TRUE表示成功 FALSE表示失败</returns>
        public static bool MakeKeyFrame(IntPtr lLoginID, int nChannelID, int nSubChannel)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_MakeKeyFrame(lLoginID, nChannelID, nSubChannel);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <returns>TRUE表示成功 FALSE表示失败</returns>
        public static bool StopService(IntPtr lHandle)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_StopService(lHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 订阅客流统计服务实时数据
        /// Attach video statistics real-time data
        /// </summary>
        /// <returns>返回处理句柄</returns>
        public static IntPtr AttachVideoStatistics(IntPtr lLoginID, ref NET_IN_ATTACH_VIDEO_STATISTICS pstInParam, ref NET_OUT_ATTACH_VIDEO_STATISTICS pstOutParam, int nWaitTime)
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_AttachVideoStatistics(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 取消订阅客流统计服务实时数据
        /// Detach video statistics real-time data
        /// </summary>
        /// <returns>TRUE表示成功 FALSE表示失败</returns>
        public static bool DetachVideoStatistics(IntPtr lAttachHandle)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_DetachVideoStatistics(lAttachHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstInParam 接口输入参数, 内存资源由用户申请和释放; [in] pstInParam Interface input parameters, memory resources are requested and released by the user</param>
        /// <param name="pstuOutParam">[out] pstOutParam 接口输出参数, 内存资源由用户申请和释放; [out] pstOutParam Interface output parameters, memory resources are requested and released by users</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime interface timeout, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
        public static bool ManualSendSMS(IntPtr lLoginID, ref NET_IN_MANUAL_SEND_SMS_INFO pstuInParam, ref NET_OUT_MANUAL_SEND_SMS_INFO pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_ManualSendSMS(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime interface timeout, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
        public static bool ManualMakeCall(IntPtr lLoginID, ref NET_IN_MANUAL_MAKE_CALL_INFO pstuInParam, ref NET_OUT_MANUAL_MAKE_CALL_INFO pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_ManualMakeCall(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">NET_IN_TRIGGER_ALARM_INFO [in] pstInParam 接口输入参数, 内存资源由用户申请和释放; [in] pstInParam Interface input parameters, memory resources are requested and released by the user</param>
        /// <param name="pstuOutParam">NET_OUT_TRIGGER_ALARM_INFO[out] pstOutParam 接口输出参数, 内存资源由用户申请和释放; [out] pstOutParam Interface output parameters, memory resources are requested and released by users</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime interface timeout, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
        public static bool TriggerUnifiedInfoCollectAlarm(IntPtr lLoginID, IntPtr pstuInParam, IntPtr pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_TriggerUnifiedInfoCollectAlarm(lLoginID, pstuInParam, pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
    ...
    /// </summary>
    public delegate void fViewRangeStateCallBack(IntPtr lLoginID, IntPtr lAttachHandle, IntPtr pBuf, int nBufLen, IntPtr dwUser);

    /// <summary>
    /// 立体行为-视频统计信息回调函数原形，lAttachHandle 是 CLIENT_AttachVideoStatistics返回值
    /// StereoBehavior-Video statistics data callback function,lAttachHandle is the return value of CLIENT_AttachVideoStatistics
    /// </summary>
    public delegate void fVideoStatisticsInfoCallBack(IntPtr lAttachHandle, EM_VS_TYPE emType, IntPtr pBuf, uint dwBufLen, IntPtr dwUser);

    /// <summary>
    /// TTLV异步搜索设备回调(pDevNetInfo内存由SDK内部申请释放)
    /// TTLV Asynchronism search device call
    /// </summary>
    public delegate void fSearchDevicesCBTTLV(IntPtr lSearchHandle, IntPtr pDevNetInfo, IntPtr pUserData);
